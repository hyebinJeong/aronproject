                        ...
                        <div>
                            ...
                            <form style={{ width: '100%', marginTop: '8%', display: 'flex', flexWrap: 'wrap', flexDirection: 'column' }} onSubmit={(e) => e.preventDefault()}>
                                ...
                                <div style={{ display: 'flex', justifyContent: "center" }}>
                                    <button style={{ width: '15vw', height: '5vh', marginTop: '6%', padding: '1.5%', display: 'flex', alignItems: 'center', justifyContent: "center", border: 'none', color: '#ddd', backgroundColor: '#0d47a1', borderRadius: '0.7em', fontWeight: '600', fontSize: '1em' }} onClick={handleSave}>SAVE</button>
                                </div>
                            </form>
                        </div>
                    </div>
